"""Binary for training translation models base on tensorflow/models/rnn/translate/translate.py.
...
# train_decode specific
tf.app.flags.DEFINE_string("atts_out", None, "attentions dump file")
